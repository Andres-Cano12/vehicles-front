...
@Component({
  ...
  template: `
    ...
    providers: [ WebStorageService, AuthService ]
})
export class AppSidebarNavComponent {
  ...
  public AllowUser(item) {
    return this.authService.currentUserHasRole(item.roles);
  }
}
...
import { WEB_STORAGE_KEYS } from 'app/config/configuration';
...
export class AppSidebarNavLinkComponent {
  ...
  public AllowUser() {
    // return this.authService.currentUserHasRole(this.link.roles);
    return true;
  }
