...
export class Utilities {
    ...
    public static DateInRange(start: Date, end: Date, evalue: Date) {
        return (new Date(start).getTime() <= new Date(evalue).getTime()) 
                && (new Date(end).getTime() >= new Date(evalue).getTime());
    }

    public static getDurationDays(start: Date, end: Date) {
    ...
    public static getDurationHours(start: Date, end: Date) {
    ...
    public static getDurationMinutes(start: Date, end: Date) {
    ...
    public static getDurationSeconds(start: Date, end: Date) {
    ...
    // Metodo que recibe un array de numero para entregar una totalizacion numerica de este.
    public static SumArray(array){
        return array
        .reduce(function(VlrAnt, VlrAct){
          return VlrAnt + VlrAct;
        }); 
    }
}