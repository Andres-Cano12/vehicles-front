...
export class StoreManager {
    ...
    public initialiseStorageSyncListener() {
        if (StoreManager.syncListenerInitialised == true)
            return;

        StoreManager.syncListenerInitialised = true;
    ...
    public deinitialiseStorageSyncListener() {
        ...
        StoreManager.syncListenerInitialised = false;
    }
    ...
    public clearAllSessionsStorage() {
        ...
        this.clearInstanceSessionStorage();
        localStorage.removeItem(StoreManager.DBKEY_SYNC_KEYS);
    ...
    private getSyncKeysFromStorage(defaultValue: string[] = []): string[] {
        ...
        let data = this.localStorageGetItem(StoreManager.DBKEY_SYNC_KEYS);
    ...
    private addToSyncKeysBackup(key: string) {
        ...
        if (!storedSyncKeys.some(x => x == key)) {
            ...
            this.localStorageSetItem(StoreManager.DBKEY_SYNC_KEYS, storedSyncKeys);
        }
    }
    ...
    public saveSessionData(data: any, key = StoreManager.DBKEY_USER_DATA) {
    ...
    public saveSyncedSessionData(data: any, key = StoreManager.DBKEY_USER_DATA) {
    ...
    public savePermanentData(data: any, key = StoreManager.DBKEY_USER_DATA) {
    ...
    public moveDataToSessionStorage(key = StoreManager.DBKEY_USER_DATA) {
    ...
    public moveDataToSyncedSessionStorage(key = StoreManager.DBKEY_USER_DATA) {
    ...
    public moveDataToPermanentStorage(key = StoreManager.DBKEY_USER_DATA) {
    ...
    public exists(key = StoreManager.DBKEY_USER_DATA) {
    ...
    public getData(key = StoreManager.DBKEY_USER_DATA) {
        ...
        if (data == null) {
            ...
            // console.log("en getData Final");
        return data;
    }


    public getDataObject<T>(key = StoreManager.DBKEY_USER_DATA, isDateType = false): T {
    ...
    public deleteData(key = StoreManager.DBKEY_USER_DATA) {
